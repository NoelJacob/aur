...
const checkBun = async () => {
    ...
    if (v1 !== v2) {
        ...
        execSync("./makepkg ./bunjs-bin/PKGBUILD --printsrcinfo > ./bunjs-bin/.SRCINFO &&\n" +
            "cd bunjs-bin &&\n" +
    ...
    if (v1base !== v2) {
        ...
        execSync("./makepkg ./bunjs-baseline-bin/PKGBUILD --printsrcinfo > ./bunjs-baseline-bin/.SRCINFO &&\n" +
            "cd bunjs-baseline-bin &&\n" +
            "git add PKGBUILD .SRCINFO");
